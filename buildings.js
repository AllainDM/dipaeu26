...
const BUILDINGS = [
  {
    ...
    "location": "Провинция",
    "resource": "нет",
    "climate": "все (за искл. Арктики) + Степи и Пустыни (если в Пустыни нет Реки/Озера или ресурса \"Зерно\")",
    "conditions": "",
    "input": "",
  ...
  },
  {
    ...
    "income": {
      "base": 3.0,
      "max": 25.0,
      "display": "3(Ткани)+10(Пряности)+5(Благовония)+5(Сахар) х2 (ин Ярмарка, Город >= 9 размера)"
    }
  },
  {
    "name": "Базар",
